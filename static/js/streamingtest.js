						...
						janus.attach(
							{
								...
								onremotestream: function(stream) {
									...
									if($('#remotevideo').length === 0) {
										addButtons = true;
										$('#stream').append('<a-scene><a-assets><video class="rounded centered hide" id="remotevideo" width="100%" height="100%" autoplay controls/></video></a-assets><a-videosphere src="#remotevideo"></a-videosphere></a-scene>');
...
function startStream() {
	...
	if(selectedStream === undefined || selectedStream === null) {
		//if no selection, select first element
		//selectedStream = $('#streamslist li:eq(0) a').attr("id");
