! function(e) {
    ...
    return function a(o, s, c) {
        ...
        1: [function(e, t, r) {
            ...
            t.exports = function(L, I) {
                function j(e, t) {
                    t.addTrack(e), t.dispatchEvent(new L.MediaStreamTrackEvent("addtrack", {
                        track: e
                    }))
                }
                ...
                function i(e, t, r, n) {
                    ...
                    i.track = t, i.receiver = r, i.transceiver = {
                        receiver: r
                    }, i.streams = n, L.setTimeout(function() {
                ...
                var n = function(e) {
                    ...
                    if (e.iceServers = (t = e.iceServers || [], n = I, i = !1, (t = JSON.parse(JSON.stringify(t))).filter(function(e) {
                            if (e && (e.urls || e.url)) {
                                var t = e.urls || e.url;
                        ...
                        for (var o = e.iceCandidatePoolSize; 0 < o; o--) this._iceGatherers.push(new L.RTCIceGatherer({
                ...
                n.prototype.onicecandidate = null, n.prototype.onaddstream = null, n.prototype.ontrack = null, n.prototype.onremovestream = null, n.prototype.onsignalingstatechange = null, n.prototype.oniceconnectionstatechange = null, n.prototype.onconnectionstatechange = null, n.prototype.onicegatheringstatechange = null, n.prototype.onnegotiationneeded = null, n.prototype.ondatachannel = null, n.prototype._dispatchEvent = function(e, t) {
                    ...
                    return r || (r = this._createTransceiver(t.kind)), this._maybeFireNegotiationNeeded(), -1 === this.localStreams.indexOf(e) && this.localStreams.push(e), r.track = t, r.stream = e, r.rtpSender = new L.RTCRtpSender(t, r.dtlsTransport), r.rtpSender
                }, n.prototype.addStream = function(t) {
                    var r = this;
                    if (15025 <= I) t.getTracks().forEach(function(e) {
                        r.addTrack(e, t)
                    });
                    else {
                        var n = t.clone();
                    ...
                    if (!(t instanceof L.RTCRtpSender)) throw new TypeError("Argument 1 of RTCPeerConnection.removeTrack does not implement interface RTCRtpSender.");
                    ...
                    }, e.recvEncodingParameters.length && (n.rtcp.ssrc = e.recvEncodingParameters[0].ssrc), e.rtpSender.send(n)), r && e.rtpReceiver && 0 < n.codecs.length && ("video" === e.kind && e.recvEncodingParameters && I < 15019 && e.recvEncodingParameters.forEach(function(e) {
                        delete e.rtx
                    ...
                    return w.canTrickleIceCandidates = !!t && 0 <= t.substr(14).split(" ").indexOf("trickle"), e.forEach(function(e, t) {
                        ...
                        if ("application" === n && "DTLS/SCTP" === a || i) w.transceivers[t] = {
                            ...
                            if (("offer" === k.type || "answer" === k.type) && !i && D && 0 < t && w.transceivers[t] && (w._disposeIceAndDtlsTransports(t), w.transceivers[t].iceGatherer = w.transceivers[0].iceGatherer, w.transceivers[t].iceTransport = w.transceivers[0].iceTransport, w.transceivers[t].dtlsTransport = w.transceivers[0].dtlsTransport, w.transceivers[t].rtpSender && w.transceivers[t].rtpSender.setTransport(w.transceivers[0].dtlsTransport), w.transceivers[t].rtpReceiver && w.transceivers[t].rtpReceiver.setTransport(w.transceivers[0].dtlsTransport)), "offer" !== k.type || i) "answer" !== k.type || i || (p = (d = w.transceivers[t]).iceGatherer, u = d.iceTransport, f = d.dtlsTransport, l = d.rtpReceiver, m = d.sendEncodingParameters, h = d.localCapabilities, w.transceivers[t].recvEncodingParameters = v, w.transceivers[t].remoteCapabilities = T, w.transceivers[t].rtcpParameters = S, P.length && "new" === u.state && (!M && !R || D && 0 !== t ? P.forEach(function(e) {
                                A(d.iceTransport, e)
                            }) : u.setRemoteCandidates(P)), D && 0 !== t || ("new" === u.state && u.start(p, y, "controlling"), "new" === f.state && f.start(C)), w._transceive(d, "sendrecv" === o || "recvonly" === o, "sendrecv" === o || "sendonly" === o), !l || "sendrecv" !== o && "sendonly" !== o ? delete d.rtpReceiver : (g = l.track, s ? (_[s.stream] || (_[s.stream] = new L.MediaStream), j(g, _[s.stream]), x.push([g, l, _[s.stream]])) : (_.default || (_.default = new L.MediaStream), j(g, _.default), x.push([g, l, _.default]))));
                            else {
                                (d = w.transceivers[t] || w._createTransceiver(n)).mid = c, d.iceGatherer || (d.iceGatherer = w._createIceGatherer(t, D)), P.length && "new" === d.iceTransport.state && (!R || D && 0 !== t ? P.forEach(function(e) {
                                    A(d.iceTransport, e)
                                }) : d.iceTransport.setRemoteCandidates(P)), h = L.RTCRtpReceiver.getCapabilities(n), I < 15019 && (h.codecs = h.codecs.filter(function(e) {
                                    return "rtx" !== e.name
                                ...
                                if ("sendrecv" === o || "sendonly" === o) {
                                    if (b = !d.rtpReceiver, l = d.rtpReceiver || new L.RTCRtpReceiver(d.dtlsTransport, n), b) g = l.track, s && "-" === s.stream || (s ? (_[s.stream] || (_[s.stream] = new L.MediaStream, Object.defineProperty(_[s.stream], "id", {
                                        get: function() {
                                            return s.stream
                                        }
                                    ...
                                    }), E = _[s.stream]) : (_.default || (_.default = new L.MediaStream), E = _.default)), E && (j(g, E), d.associatedRemoteMediaStreams.push(E)), x.push([g, l, E])
                                    ...
                                    n && (t = n, (r = e).removeTrack(t), r.dispatchEvent(new L.MediaStreamTrackEvent("removetrack", {
                                        track: t
                                    })))
                        ...
                        if (n.getTracks().length) {
                            if (-1 === w.remoteStreams.indexOf(n)) {
                                ...
                                t.stream = n, L.setTimeout(function() {
                    ...
                    s.transceivers.forEach(function(e, t) {
                        ...
                        var a = L.RTCRtpSender.getCapabilities(n);
                        I < 15019 && (a.codecs = a.codecs.filter(function(e) {
                            return "rtx" !== e.name
                        ...
                        r && 15019 <= I && "video" === n && !o[0].rtx && (o[0].rtx = {
                            ssrc: o[0].ssrc + 1
                        }), e.wantReceive && (e.rtpReceiver = new L.RTCRtpReceiver(e.dtlsTransport, n)), e.localCapabilities = a, e.sendEncodingParameters = o
                    ...
                    var i = new L.RTCSessionDescription({
                        type: "offer",
                        sdp: n
                    });
                    ...
                    i.transceivers.forEach(function(e, t) {
                        if (!(o < t + 1)) {
                            ...
                            var r;
                            if (e.stream) "audio" === e.kind ? r = e.stream.getAudioTracks()[0] : "video" === e.kind && (r = e.stream.getVideoTracks()[0]), r && 15019 <= I && "video" === e.kind && !e.sendEncodingParameters[0].rtx && (e.sendEncodingParameters[0].rtx = {
                    ...
                    var e = new L.RTCSessionDescription({
                        type: "answer",
                        sdp: a
                    });
